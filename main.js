...
const firebaseConfig = {
    apiKey: "AIzaSyDuP2jWOAQdx-fHT2wKPHO4YVlnps3Jfj4",
  authDomain: "pixelrush01.firebaseapp.com",
  databaseURL: "https://pixelrush01-default-rtdb.firebaseio.com",
  projectId: "pixelrush01",
  storageBucket: "pixelrush01.appspot.com",
  messagingSenderId: "391208229368",
  appId: "1:391208229368:web:95d3083e537cd4abcc1e0d",
  measurementId: "G-3DSW7GN60N"
};
...
const initGame = (lobbyName) => {
    ...
    const gameInterval = setInterval(() => {
        ...
        heroPosX += block * xVel;
        heroPosY += block * yVel;
        trails[`${heroPosX},${heroPosY}`] = "anto is awesome right";
